...
Lookup Functions – Extracting employee-specific data.
...
Filtering – Unique filters ensure distinct values.

Analysis – Salary growth, department distribution, gender balance, and performance ratings.
...
Line chart showing how average salary increases with years of experience.

Highlights career progression and compensation trends.

Department Distribution Chart

Pie chart showing employee count across Finance, HR, IT, and Sales.

Useful for workforce planning and resource allocation.

Gender Balance Chart

Bar chart comparing male vs female employees.

Demonstrates equal representation (25 male, 25 female).

Performance Rating Chart

Column chart showing distribution of ratings (2–5).
...
Majority of employees rated 4 or 5.

Charts make trends easy to interpret and present.
